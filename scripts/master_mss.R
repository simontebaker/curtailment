...
# # Example of how to create item_definitions with different rating scales (e.g., reverse-scored questions/items)
...
# Create item_definitions for Maladaptive Schema Scale (MSS-v1.4)
# Questions/Items 3, 9, 16, 23, 30, 36, 38, 43, 48, 59, 65, 70, 73, 76, 77, 81, 90 are reverse-scored

# Define the typical rating scale for MSS
rateValues <- list(
  list(value = 0, text = "Strongly disagree"),
  list(value = 1, text = "Disagree"),
  list(value = 2, text = "Neutral"),
...
# Define the reverse-scored rating scale for MSS
...
item_definitions <- list(
  ...
  q5 = list(
    item_id = "q5",
    item_text = "I always depend on myself and never on other people.",
    rateValues = rateValues
  ),
  
  q6 = list(
    item_id = "q6",
    item_text = "I feel uneasy when people get too close.",
    rateValues = rateValues
  ),
  
  q7 = list(
    item_id = "q7",
    item_text = "I feel extremely uncomfortable depending on other people.",
    rateValues = rateValues
  ),
  
  q8 = list(
    item_id = "q8",
    item_text = "The last thing I want to do is bother people with my problems.",
    rateValues = rateValues
  ),
  ...
  q17 = list(
    item_id = "q17",
    item_text = "Many people are selfish and unkind.",
    rateValues = rateValues
  ),
  
  q18 = list(
    item_id = "q18",
    item_text = "People rarely care about the wellbeing of others.",
    rateValues = rateValues
  ),
  
  q19 = list(
    item_id = "q19",
    item_text = "Violence is a major part of human nature.",
    rateValues = rateValues
  ),
  
  q20 = list(
    item_id = "q20",
    item_text = "At their core, many people are bad.",
    rateValues = rateValues
  ),
  ...
  q45 = list(
    item_id = "q45",
    item_text = "The course of our lives are largely determined by chance; we have very little influence.",
    rateValues = rateValues
  ),
  
  q46 = list(
    item_id = "q46",
    item_text = "No matter what I do, the outcomes of events are outside my control.",
    rateValues = rateValues
  ),
  
  q47 = list(
    item_id = "q47",
    item_text = "There is no point trying to influence the future, because outside forces have more influence.",
    rateValues = rateValues
  ),
  
  q48 = list(
    item_id = "q48",
    item_text = "I am in control of my future.",
    rateValues = reverse_rateValues
  ),
  ...
  q89 = list(
    item_id = "q89",
    item_text = "I am in complete control of my future.",
    rateValues = rateValues
  ),
  
  q90 = list(
    item_id = "q90",
    item_text = "There are limits to what I can do.",
    rateValues = reverse_rateValues
  ),
  
  q91 = list(
    item_id = "q91",
    item_text = "If I exert enough willpower, I can change anything.",
    rateValues = rateValues
  ),
  
  q92 = list(
    item_id = "q92",
    item_text = "I always maintain control so nothing is left up to chance.",
    rateValues = rateValues
  ),
  
  q93 = list(
    item_id = "q93",
    item_text = "When my head says one thing and my heart says another, I listen to my heart.",
    rateValues = rateValues
  ),
  
  q94 = list(
    item_id = "q94",
    item_text = "My feelings are a reliable way to make decisions.",
    rateValues = rateValues
  ),
  
  q95 = list(
    item_id = "q95",
    item_text = "My emotional reactions are accurate reflections of reality.",
    rateValues = rateValues
  ),
  
  q96 = list(
    item_id = "q96",
    item_text = "When I face a problem I prefer to use my intuition rather than thinking.",
    rateValues = rateValues
  ),
  
  q97 = list(
    item_id = "q97",
    item_text = "There is no justice in society.",
    rateValues = rateValues
  ),
  
  q98 = list(
    item_id = "q98",
    item_text = "I am often treated unfairly.",
    rateValues = rateValues
  ),
  
  q99 = list(
    item_id = "q99",
    item_text = "I commonly receive bad outcomes that I don't deserve.",
    rateValues = rateValues
  ),
  
  q100 = list(
    item_id = "q100",
    item_text = "Good things happen to other people but not to me.",
    rateValues = rateValues
  ),
  
  q101 = list(
    item_id = "q101",
    item_text = "I have no purpose in the world.",
    rateValues = rateValues
  ),
  
  q102 = list(
    item_id = "q102",
    item_text = "It is pointless to search for life's meaning or purpose.",
    rateValues = rateValues
  ),
  
  q103 = list(
    item_id = "q103",
    item_text = "Everything I do will always be fundamentally meaningless.",
    rateValues = rateValues
  ),
  
  q104 = list(
    item_id = "q104",
    item_text = "Humans lead pointless lives.",
    rateValues = rateValues
  ),
  
  q105 = list(
    item_id = "q105",
    item_text = "I struggle to maintain a consistent sense of who I am.",
    rateValues = rateValues
  ),
  
  q106 = list(
    item_id = "q106",
    item_text = "I don't know what my personal interests and beliefs truly are.",
    rateValues = rateValues
  ),
  
  q107 = list(
    item_id = "q107",
    item_text = "I feel detached from myself.",
    rateValues = rateValues
  ),
  
  q108 = list(
    item_id = "q108",
    item_text = "My view of myself changes frequently.",
    rateValues = rateValues
  )
)
